          ...
          <div className="grid gap-10 lg:grid-cols-[0.75fr_1.25fr] lg:gap-16">
            ...
            <div className="max-w-md">
              ...
              <p className="mt-5 text-sm leading-7 text-slate-600 sm:text-base">
                ...
                enquiry. This frontend form currently demonstrates the
                validation and submission experience only.
              </p>
              ...
              <div className="mt-7 rounded-2xl bg-[#edf7ff] p-5">
                ...
                <p className="mt-2 text-xs leading-5 text-slate-500">
                  Submitting this form does not send an email or create a
                  backend request. A real submission service can be connected
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-4 max-w-lg text-sm leading-7 text-slate-600 sm:text-base">
                Our current working-hour information is shown below. Please
                confirm availability when scheduling an appointment.
              </p>
