...
function DoctorDetails() {
  ...
  if (!doctor) {
    return (
      <>
        <SEO
          title="Doctor Not Found | GreenCare Clinic"
          description="The requested doctor profile could not be found. Explore the healthcare professionals available at GreenCare Clinic."
          canonical={`https://greencare-clinic.vercel.app/doctors/${id}`}
        />
  ...
  return (
    <>
      <SEO
        title={`${doctor.name} | ${doctor.specialization} | GreenCare Clinic`}
        description={`Learn about ${doctor.name}, ${doctor.specialization} at GreenCare Clinic, including qualifications, experience, expertise, availability, and clinical services.`}
        canonical={`https://greencare-clinic.vercel.app/doctors/${doctor.id}`}
      />
