        ...
        <section className="bg-[#edf7ff]">
          <Container>
            <ScrollReveal>
              <div
                className="
                  grid min-h-[420px] items-center gap-10 py-12
              ...
              >
                ...
                >
                  <img
                    src={aboutHeroImage}
                    alt="Professional healthcare team at GreenCare Clinic"
                    className="
                      absolute inset-0
                      h-full w-full
                      object-cover
            ...
            <ScrollReveal direction="up">
              <div className="grid items-center gap-12 lg:grid-cols-2">
                ...
                <div className="relative overflow-hidden rounded-[2.5rem] rounded-br-[7rem] bg-slate-100">
                  <img
                    src={clinicStoryImage}
                    alt="Doctor providing patient-focused care at GreenCare Clinic"
            ...
            <ScrollReveal>
              <div className="grid items-center gap-12 lg:grid-cols-[0.9fr_1.1fr]">
                ...
                <div className="relative overflow-hidden rounded-[2.5rem] rounded-bl-[7rem] bg-slate-100">
                  <img
                    src={clinicEnvironmentImage}
                    alt="Modern and welcoming healthcare environment at GreenCare Clinic"
                    className="aspect-[4/3] w-full object-cover"
                    loading="lazy"
                    decoding="async"
                  />
          ...
          <Container>
            <ScrollReveal>
              <div className="mx-auto max-w-2xl text-center">
                ...
                <p className="mt-4 text-sm leading-6 text-slate-600 sm:text-base">
                  We aim to make the healthcare experience clear, respectful,
